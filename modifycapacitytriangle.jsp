  ...
  <body background="images/fond.gif">
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectdetails.jsp?TODO=CTMOD&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT CAPACITYTRIANGLE FROM PROJECT WHERE ID='"+PROJECTID+"'";
        ...
        STR01.close();
        out.print("<table>");
        out.print("<tr><td>Status : </td><td><select name=\"CAPACITYTRIANGLE\">");
        out.print("<option");
        if (CAPACITYTRIANGLE.equals("L")) {
          out.print(" selected ");
        }
        out.print(">Local</option>");
        out.print("<option");
        if (CAPACITYTRIANGLE.equals("G")) {
          out.print(" selected ");
        }
        out.print(">Global</option>"); 
