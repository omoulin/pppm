  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        if (REQ.equals("N")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectdetails.jsp?TODO=DIVDELETE&DIVISIONID="+DIVISIONID+"&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"requestdetails.jsp?TODO=DIVDELETE&DIVISIONID="+DIVISIONID+"&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">");
        }
        out.print("<table>");
        ...
        STR02.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this division from this project ??</H1></td><td>&nbsp;</td></tr>");
