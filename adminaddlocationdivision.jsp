  ...
  <body background="images/fond.gif">
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          DIVISIONID="";
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"adminlocation.jsp?TODO=DIVADD\" target=\"appliFrame\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"adminlocation.jsp?TODO=DIVMOD&DIVISIONID="+DIVISIONID+"\" target=\"appliFrame\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT NAME FROM DIVISION WHERE ID='"+DIVISIONID+"'";
        ...
        out.print("<table>");
        if (act.equals("ADD")) {
          out.print("<tr><td>ID : </td><td><input name=\"DIVISIONID\" type=\"text\" size=\"50\" value=\"\"></td></tr>");
        }   
