  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"resourcecalendar.jsp?TODO=ADD&EMPLOYEEID="+EMPLOYEEID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        out.print("<td><A HREF=\"resourcecalendar.jsp?TODO=NONE&EMPLOYEEID="+EMPLOYEEID+"\"><img border=0 src=\"icons/cancel.png\"></A></td></tr></table>");
        out.print("</table>");
        out.print("</form>");
        Conn.close();
      }
