  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        while(R01.next()) {
          out.print("<tr><td><A HREF=\"productresourcesactivity.jsp?TODO=USRPROFILE&EMPLOYEEID="+EMPLOYEEID+"&PROFILEID="+R01.getString("ID")+"&PRODUCTID="+PRODUCTID+"&ACTIVITYID="+ACTIVITYID+"\">"+R01.getString("ID")+"</td>");
