  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          GROUPID="";
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"group.jsp?TODO=ADD&PAGE="+currentpage+"\" target=\"appliFrame\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"group.jsp?TODO=MOD&GROUPID="+GROUPID+"&PAGE="+currentpage+"\" target=\"appliFrame\">");
        }
        if (act.equals("MOD")) {
          Group g = new Group(Conn,GROUPID);
            NAME=g.getName();
        }
        out.print("<table>");
        ...
        if (act.equals("ADD")) {
          ...
          out.print("<td><A HREF=\"group.jsp?TODO=NONE&PAGE="+currentpage+"\"><img border=0 src=\"icons/cancel.png\"></A></td></tr></table>");
        } else {  
