  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        Product prd = new Product(Conn,PRODUCTID);
        ...
        String q30 = "SELECT SUM(AMOUNT) FROM PRODUCT_BUDGET WHERE PRODUCTID='"+PRODUCTID+"' AND TYPE='C'";
        ...
        q30 = "SELECT SUM(AMOUNT) FROM PRODUCT_BUDGET WHERE PRODUCTID='"+PRODUCTID+"' AND TYPE='E'";
        ...
        st30.close();
        st30 = Conn.createStatement();
        q30 = "SELECT SUM(AMOUNT) FROM PRODUCT_EXPENSE WHERE PRODUCTID='"+PRODUCTID+"' AND TYPE='C'";
        r30 = st30.executeQuery(q30);
        if(r30.next()) {
        ...
        st30.close();
        st30 = Conn.createStatement();
        q30 = "SELECT SUM(AMOUNT) FROM PRODUCT_EXPENSE WHERE PRODUCTID='"+PRODUCTID+"' AND TYPE='E'";
        r30 = st30.executeQuery(q30);
        if(r30.next()) {
        ...
        if (RO.equals("NO")) {
          out.print("<td><A HREF=\"addproductbudget.jsp?TODO=ADD&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        }
        ...
        out.print("</tr>");
        st30 = Conn.createStatement();
        q30 = "SELECT * FROM PRODUCT_BUDGET WHERE PRODUCTID='"+PRODUCTID+"'";
        r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr height=\"30\">");
          ...
          if (RO.equals("NO")) {
            out.print("<td width=\"10%\"><A HREF=\"addproductbudget.jsp?TODO=MOD&PRODUCTID="+PRODUCTID+"&BUDGETID="+r30.getString("ID")+"\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
          }
          ...
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"deleteproductbudget.jsp?TODO=DELETE&PRODUCTID="+PRODUCTID+"&BUDGETID="+r30.getString("ID")+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          } else {
            out.print("<td>&nbsp;</td>");
          }
          out.print("</tr>");
        ...
        if (RO.equals("NO")) {
          out.print("<td><A HREF=\"addproductexpense.jsp?TODO=ADD&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        }
        out.print("</tr></table></td>");
        ...
        out.print("</tr>");
        st30 = Conn.createStatement();
        q30 = "SELECT * FROM PRODUCT_EXPENSE WHERE PRODUCTID='"+PRODUCTID+"'";
        r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr height=\"30\">");
          out.print("<td><center>&nbsp;</center></A></td>");
          ...
          out.print("<td bgcolor=\"#FFFFFF\"><table width=\"100%\"><tr><td width=\"30%\">"+r30.getString("DESCRIPTION")+"</td>");
          if (RO.equals("NO")) {
            out.print("<td width=\"10%\"><A HREF=\"addproductexpense.jsp?TODO=MOD&PRODUCTID="+PRODUCTID+"&EXPENSEID="+r30.getString("ID")+"\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
          }
          ...
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"deleteproductexpense.jsp?TODO=DELETE&PRODUCTID="+PRODUCTID+"&EXPENSEID="+r30.getString("ID")+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          } else {
            out.print("<td>&nbsp;</td>");
          }
          out.print("</tr>");
