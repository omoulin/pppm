    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        String APPLICATIONID = request.getParameter("APPLICATIONID");
      	out.print("<hr>");
        String CLOSED = "";
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationdetails.jsp?TODO=CLOSED&APPLICATIONID="+APPLICATIONID+"\" target=\"_top\">");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT CLOSED FROM APPLICATION WHERE ID='"+APPLICATIONID+"'";
        ...
        STR01.close();
        out.print("<table>");
        out.print("<tr><td>Application Closed : </td><td><select name=\"CLOSED\">");
        out.print("<option");
        if (CLOSED.equals("Y")) {
          out.print(" selected ");
        }
