  ...
  <body>
    <%
      ...
      if (Userlogin==null) {
        ...
        Application prd = new Application(Conn,APPLICATIONID);
        if (act.equals("BUDADD")) {
          if (pt.checknum(request.getParameter("AMOUNT"))) {
            ...
            prd.addBudget(DESCRIPTION,TYPE,AMOUNT,CER,DATEBUD);
          } else {
        ...
        if (act.equals("BUDMOD")) {
          if (pt.checknum(request.getParameter("AMOUNT"))) {
            ...
            String CER = pt.checkStr(request.getParameter("CER"));
            String DATEBUD = request.getParameter("DATEBUD");
            prd.modifyBudget(BUDGETID,DESCRIPTION,TYPE,AMOUNT,CER,DATEBUD);
          } else {
            out.print("<HR>ERROR IN THE FORMAT OF THE NUMBER</HR>");
          }
        }
        if (act.equals("EXPADD")) {
          if (pt.checknum(request.getParameter("AMOUNT"))) {
            ...
            prd.addExpense(DESCRIPTION,TYPE,AMOUNT,DATEEXP,VENDORID,INVOICE);
          } else {
            out.print("<HR>ERROR IN THE FORMAT OF THE NUMBER</HR>");
          }
        }
        if (act.equals("EXPMOD")) {
          if (pt.checknum(request.getParameter("AMOUNT"))) {
            ...
            String DATEEXP = request.getParameter("DATEEXP");
            String INVOICE = pt.checkStr(request.getParameter("INVOICE"));
            prd.modifyExpense(EXPENSEID,DESCRIPTION,TYPE,AMOUNT,DATEEXP,VENDORID,INVOICE);
          } else {
            out.print("<HR>ERROR IN THE FORMAT OF THE NUMBER</HR>");
          }
        }
        if (act.equals("BUDDELETE")) {
          String BUDGETID = request.getParameter("BUDGETID");
          prd.deleteBudget(BUDGETID);
        }
        if (act.equals("EXPDELETE")) {
          String EXPENSEID = request.getParameter("EXPENSEID");
          prd.deleteExpense(EXPENSEID);
        }
        out.print("<center><table><tr><td><img border=0 src=\"icons/financials.png\"></td><td><strong><h1>Application financials</h1></strong></td></tr></table></center><hr>");
        ...
        String q30 = "SELECT SUM(AMOUNT) FROM APPLICATION_BUDGET WHERE APPLICATIONID='"+APPLICATIONID+"' AND TYPE='C'";
        ...
        q30 = "SELECT SUM(AMOUNT) FROM APPLICATION_BUDGET WHERE APPLICATIONID='"+APPLICATIONID+"' AND TYPE='E'";
        ...
        st30.close();
        st30 = Conn.createStatement();
        q30 = "SELECT SUM(AMOUNT) FROM APPLICATION_EXPENSE WHERE APPLICATIONID='"+APPLICATIONID+"' AND TYPE='C'";
        r30 = st30.executeQuery(q30);
        if(r30.next()) {
        ...
        st30.close();
        st30 = Conn.createStatement();
        q30 = "SELECT SUM(AMOUNT) FROM APPLICATION_EXPENSE WHERE APPLICATIONID='"+APPLICATIONID+"' AND TYPE='E'";
        r30 = st30.executeQuery(q30);
        if(r30.next()) {
        ...
        if (RO.equals("NO")) {
          out.print("<td><A HREF=\"addapplicationbudget.jsp?TODO=ADD&APPLICATIONID="+APPLICATIONID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        }
        ...
        out.print("</tr>");
        st30 = Conn.createStatement();
        q30 = "SELECT * FROM APPLICATION_BUDGET WHERE APPLICATIONID='"+APPLICATIONID+"'";
        r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr height=\"30\">");
          ...
          if (RO.equals("NO")) {
            out.print("<td width=\"10%\"><A HREF=\"addapplicationbudget.jsp?TODO=MOD&APPLICATIONID="+APPLICATIONID+"&BUDGETID="+r30.getString("ID")+"\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
          }
          ...
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"deleteapplicationbudget.jsp?TODO=DELETE&APPLICATIONID="+APPLICATIONID+"&BUDGETID="+r30.getString("ID")+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          } else {
            out.print("<td>&nbsp;</td>");
          }
          out.print("</tr>");
        ...
        if (RO.equals("NO")) {
          out.print("<td><A HREF=\"addapplicationexpense.jsp?TODO=ADD&APPLICATIONID="+APPLICATIONID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        }
        out.print("</tr></table></td>");
        ...
        out.print("</tr>");
        st30 = Conn.createStatement();
        q30 = "SELECT * FROM APPLICATION_EXPENSE WHERE APPLICATIONID='"+APPLICATIONID+"'";
        r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr height=\"30\">");
          out.print("<td><center>&nbsp;</center></A></td>");
          ...
          out.print("<td bgcolor=\"#FFFFFF\"><table width=\"100%\"><tr><td width=\"30%\">"+r30.getString("DESCRIPTION")+"</td>");
          if (RO.equals("NO")) {
            out.print("<td width=\"10%\"><A HREF=\"addapplicationexpense.jsp?TODO=MOD&APPLICATIONID="+APPLICATIONID+"&EXPENSEID="+r30.getString("ID")+"\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
          }
          ...
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"deleteapplicationexpense.jsp?TODO=DELETE&APPLICATIONID="+APPLICATIONID+"&EXPENSEID="+r30.getString("ID")+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          } else {
            out.print("<td>&nbsp;</td>");
          }
          out.print("</tr>");
