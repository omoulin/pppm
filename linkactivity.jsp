  ...
  <body background="images/fond.gif">
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectplanning.jsp?TODO=LNKADD&PROJECTID="+PROJECTID+"&FROMID="+FROMID+"\" target=\"_top\">");
        out.print("<table>");
        out.print("<tr><td>Link to: </td><td><select name=\"TOID\">");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT ID,NAME FROM PROJECT_ACTIVITY WHERE ID<>"+FROMID+" AND PROJECTID='"+PROJECTID+"' AND FATHER<>'ROOT'";
