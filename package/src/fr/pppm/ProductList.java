...
String query;
Vector prdlist = new Vector();

public ProductList (Connection Conn,String q) throws Exception {
...
public void refresh() throws Exception {
  ...
  while (r12.next()) {
    prdlist.add(new Product(productConnection,r12.getString("ID"))); 
  }
  st12.close();
}
...
public Product getProductItem(int i) {
  return (Product)prdlist.elementAt(i);
}
