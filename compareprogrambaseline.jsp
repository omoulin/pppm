  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<center><table><tr><td><img border=0 src=\"icons/compare.png\"></td><td><strong><h1>Project planning baseline comparison</h1></strong></td></tr></table></center><hr>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr BGCOLOR=\"#9A9A9A\" height=\"30\">");
        out.print("<td width=\"5%\" background=\"images/fond_titre.jpg\"><center>#</center></td>");
        out.print("<td width=\"5%\" background=\"images/fond_titre.jpg\"><center>Project</center></td>");
        out.print("<td width=\"25%\" background=\"images/fond_titre.jpg\"><center>Activity <br>(Current / Baseline)</center></td>");
        ...
        String QR01 = "SELECT PROJECTID,ACTIVITYID,DATE_START,DATE_END,WORKLOAD,DURATION,NAME FROM PROGRAM_BASELINE_ACTIVITY WHERE PROGRAMID='"+PROGRAMID+"' AND BASELINEID="+BASELINEID;
        ResultSet R01 = STR01.executeQuery(QR01);
        while(R01.next()) {
          Statement STR02 = Conn.createStatement();
          String QR02 = "SELECT NAME,DATE_START,DATE_END,ID,DURATION,WORKLOAD FROM PROJECT_ACTIVITY WHERE PROJECTID='"+R01.getString("PROJECTID")+"' AND ID="+R01.getInt("ACTIVITYID");
          ...
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+R01.getString("PROJECTID")+"</center></A></td>");
        ...
        STR01.close();
        out.print("</table>");
        out.print("<br><center><A HREF=\"programbaseline.jsp?TODO=NONE&PROGRAMID="+PROGRAMID+"\">Return</A></center>");
        Conn.close();
      }
