  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {  
          out.print("<center><table><tr><td><img border=0 src=\"icons/risks.png\"></td><td><strong><h1>Add product risk</h1></strong></td></tr></table></center><hr>");
        } else {
          out.print("<center><table><tr><td><img border=0 src=\"icons/risks.png\"></td><td><strong><h1>Modify product risk</h1></strong></td></tr></table></center><hr>");
        }
        out.print("<hr>");
        String NAME = "";
        String DESCRIPTION = "";
        ...
        String CLOSED="N";
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productrisk.jsp?TODO=RSKADD&PRODUCTID="+PRODUCTID+"\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productrisk.jsp?TODO=RSKMOD&PRODUCTID="+PRODUCTID+"&RISKID="+RISKID+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,NAME,DESCRIPTION,DATE_DISCOVER,DATE_CLOSING,EMPLOYEEID,IMPACT,LIKELIHOOD,ESCALATE,CLOSED FROM PRODUCT_RISK WHERE PRODUCTID='"+PRODUCTID+"' AND ID="+RISKID;
        ...
        if (act.equals("ADD")) {
          ...
          out.print("<td><A HREF=\"productrisk.jsp?TODO=NONE&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/cancel.png\"></A></td></tr></table>");
        } else {  
