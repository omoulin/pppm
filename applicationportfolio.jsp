...
.show {
  ...
  <body>
    ...
    function showModalADD()
    {
     ...
     <script>
    function showModalAPPDETAILS(reqstr)
    {
    	window.showModalDialog('applicationdetails.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='applicationportfolio.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalAPPBUDGET(reqstr)
    {
    	window.showModalDialog('applicationbudget.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='applicationportfolio.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalAPPPLANNING(reqstr)
    {
    	window.showModalDialog('applicationplanning.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='applicationtportfolio.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalAPPRISK(reqstr)
    {
    	window.showModalDialog('applicationrisk.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='applicationportfolio.jsp?TODO=NONE';
    }
    </script>
    ...
    <%
    	// session attributes
              ...
              if (Userlogin==null) {
                ...
                out.print("<center><strong><h1>Application portfolio</h1></strong></center><br>");
                String COLTOSORT = "ID";
                String DIRSORT = "ASC";
                if (act.equals("SORT")) {
                ...
                out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationportfolio.jsp?TODO=FILTER&FILTER=FILTER\" target=\"appliFrame\">");
                PPMFilter filterengine = new PPMFilter(Conn);
                String LASTFILTERLOCATION=filterengine.getFilterValue("LASTFILTERLOCATIONAPPPORTFOLIO",Userlogin);
                String LASTFILTERDIVISION=filterengine.getFilterValue("LASTFILTERDIVISIONAPPPORTFOLIO",Userlogin);
                String LASTFILTERBPO=filterengine.getFilterValue("LASTFILTERBPOAPPPORTFOLIO",Userlogin);
                String LASTFILTERPM=filterengine.getFilterValue("LASTFILTERPMAPPPORTFOLIO",Userlogin);
                String LASTFILTERSI=filterengine.getFilterValue("LASTFILTERSIAPPPORTFOLIO",Userlogin);
                String LASTFILTERAT=filterengine.getFilterValue("LASTFILTERATAPPPORTFOLIO",Userlogin);
                String LASTFILTERIT=filterengine.getFilterValue("LASTFILTERITAPPPORTFOLIO",Userlogin);
                String LASTFILTERPORT=filterengine.getFilterValue("LASTFILTERPORTAPPPORTFOLIO",Userlogin);
                ...
                if (filstrlocation==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERLOCATIONAPPPORTFOLIO",Userlogin,filstrlocation);
                }
                if (filstrdivision==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERDIVISIONAPPPORTFOLIO",Userlogin,filstrdivision);
                }
                if (filstrBPO==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERBPOAPPPORTFOLIO",Userlogin,filstrBPO);
                }
                if (filstrPM==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERPMAPPPORTFOLIO",Userlogin,filstrPM);
                }
                if (filstrSI==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERSIAPPPORTFOLIO",Userlogin,filstrSI);
                }
                if (filstrAT==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERATAPPPORTFOLIO",Userlogin,filstrAT);
                }
                if (filstrIT==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERITAPPPORTFOLIO",Userlogin,filstrIT);
                }
                if (filstrPORT==null) {
                  ...
                  filterengine.setFilterValue("LASTFILTERPORTAPPPORTFOLIO",Userlogin,filstrPORT);
                }
                ...
                if (filter!= null) {
                  ...
                  if (!idfillocation.equals("***")) {
                    ...
                    filterstatement = filterstatement + " ID in (SELECT APPLICATIONID FROM APPLOC WHERE LOCATIONID='"+idfillocation+"')";
                    first = false;
                  }
                  ...
                  if (!idfildivision.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPDIV WHERE DIVISIONID='"+idfildivision+"')";
                    first = false;
                  }
                  ...
                  if (!idfilBPO.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPBPO WHERE EMPLOYEEID='"+idfilBPO+"')";
                    first = false;
                  }
                  ...
                  if (!idfilPM.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPPM WHERE EMPLOYEEID='"+idfilPM+"')";
                    first = false;
                  }
                  ...
                  if (!idfilSI.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPSI WHERE SIID='"+idfilSI+"')";
                    first = false;
                  }
                  ...
                  if (!idfilAT.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPAT WHERE ATID='"+idfilAT+"')";
                    first = false;
                  }
                  ...
                  if (!idfilIT.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPIT WHERE ITID='"+idfilIT+"')";
                    first = false;
                  }
                  ...
                  if (!idfilPORT.equals("***")) {
                    ...
                    filterstatement = filterstatement + "ID in (SELECT APPLICATIONID FROM APPPOR WHERE PORTFOLIOID='"+idfilPORT+"')";
                    first = false;
                  }
                }
                User us2 = new User(Conn);
                out.print("<table><tr><td><h2><strong>Applications(s)</strong></h2></center></td></tr></table>");
                out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
                out.print("<tr height=\"20\">");
                out.print("<td background=\"images/fond_titre.jpg\" width=\"16%\"><center><A HREF=\"applicationportfolio.jsp?TODO=SORT&FIELD=NAME&OLDFIELD="+COLTOSORT+"&OLDDIR="+DIRSORT+"\">Name</center></td>");
                ...
                out.print("</tr>");
                ApplicationList appl = new ApplicationList(Conn,"SELECT * FROM APPLICATION WHERE STATUS<>'REQUEST' "+filterstatement+" ORDER BY "+COLTOSORT+" "+DIRSORT);
                appl.refresh();
                for (int j=0; j<appl.length();j++) {
                  if (us2.hasApplicationAccess(Userlogin,appl.getApplicationItem(j).getId())) {
                    out.print("<tr height=15>");     
                    if (appl.getApplicationItem(j).getName().equals("")) {
                      out.print("<td bgcolor=\"#FFFFFF\"><center>-</center></td>");
                    } else {
                      out.print("<td bgcolor=\"#FFFFFF\"><center>&nbsp;"+appl.getApplicationItem(j).getName()+"</center></td>");
                    }   
                    String RO="NO";
                    if (appl.getApplicationItem(j).getClosed().equals("Y")) {
                      RO="YES";
                    }    
                    out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"#\" onclick=\"showModalAPPDETAILS('APPLICATIONID="+appl.getApplicationItem(j).getId()+"');\"><img border=0 src=\"icons/attributes.png\" height=15></A></center></td>");
                     out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"#\" onclick=\"showModalAPPBUDGET('APPLICATIONID="+appl.getApplicationItem(j).getId()+"');\"><img border=0 src=\"icons/financials.png\" height=15></A></center></td>");
                    out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"#\" onclick=\"showModalAPPPLANNING('APPLICATIONID="+appl.getApplicationItem(j).getId()+"');\"><img border=0 src=\"icons/planning.png\" height=15></A></center></td>");
                    out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"#\" onclick=\"showModalAPPRISK('APPLICATIONID="+appl.getApplicationItem(j).getId()+"');\"><img border=0 src=\"icons/risks.png\" height=15></A></center></td>");
                    out.print("<td bgcolor=\"#FFFFFF\"><center>&nbsp;"+appl.getApplicationItem(j).getDatestart()+"</center></td>");
                    out.print("<td bgcolor=\"#FFFFFF\"><center>&nbsp;"+appl.getApplicationItem(j).getDateend()+"</center></td>");
                    out.print("</tr>");
                  }
                }
                out.print("</table>");
