  ...
  <body background="images/fond.gif">
    <% 
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"productresourcesactivity.jsp?TODO=USRDELETE&EMPLOYEEID="+EMPLOYEEID+"&PRODUCTID="+PRODUCTID+"&ACTIVITYID="+ACTIVITYID+"\" target=\"appliFrame\">");
        out.print("<table>");
        ...
        STR03.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this employee from this activity on this product ??</H1></td><td>&nbsp;</td></tr>");
