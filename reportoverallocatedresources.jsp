  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<center><table><tr><td><img border=0 src=\"icons/report.png\"></td><td><strong><h1>Overallocated resources</h1></strong></td></tr></table></center>");
        out.print("<hr>");
        out.print("<Table><tr><td>You are here : Report \\ <A HREF=\"reportpmogroup.jsp?TODO=NONE\" target=\"appliFrame\">PMO</A> \\ Over-allocated resources</td><td><A HREF=\"reportoverallocatedresources.jsp?TODO=NONE\"><img border=0 src=\"icons/reload.png\"></A></td></tr></table>");
        out.print("<hr>");
        ...
        while (tmpyear!=end_year || tmpmonth!=end_month) {
          ...
          while (r32.next()) {
            ...
            String q232 = "SELECT SUM(WORKLOAD) FROM EMPLOYEE_RECURRING_WORKLOAD WHERE EMPLOYEEID='"+r32.getString("ID")+"' AND MONTH="+(tmpmonth+1)+" AND YEAR="+tmpyear;
            ResultSet r232 = st232.executeQuery(q232);
            if (r232.next()) {
              workload_recurring=r232.getInt("SUM(WORKLOAD)");
            }
            st232.close();
            ...
            st232.close();  
            if (workload_project+workload_recurring>(1.10*capacity)) {
              out.print("<tr>");
              ...
              out.print("<td bgcolor=\"#EFEFEF\"><center><A HREF=\"#\" onclick=\"window.showModalDialog('listteamworkload.jsp?TODO=NONE&EMPLOYEEID="+r32.getString("ID")+"&YEAR="+tmpyear+"&MONTH="+(tmpmonth+1)+"','','dialogHeight:400px;dialogWidth:800px;');\">"+(workload_project+workload_recurring)+"</A></center></A></td>"); 
