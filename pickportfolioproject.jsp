  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("You are here : Portfolio \\ <A HREF=\"portconfig.jsp?TODO=NONE\" target=\"appliFrame\"> Portfolio configuration</A> \\ <A HREF=\"portfolioproject.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\" target=\"appliFrame\">Portfolio project(s)</A> \\ Add Project");
        out.print("<hr>");

        out.print("<form name=\"formFILTER\" method=\"post\" action=\"pickportfolioproject.jsp?TODO=FILTER&FILTER=FILTER&PORTFOLIOID="+PORTFOLIOID+"&PAGE=0\" target=\"appliFrame\">");
        String LASTFILTERLOCATION=null;
        Statement STR02 = Conn.createStatement();
        String QR02 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERLOCATIONPICKPRJPOR'";
        ...
        String QR03 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERDIVISIONPICKPRJPOR'";
        ...
        String QR04 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERBPOPICKPRJPOR'";
        ...
        String QR05 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERPMPICKPRJPOR'";
        ...
        String QR06 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERSIPICKPRJPOR'";
        ...
        String QR07 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERATPICKPRJPOR'";
        ...
        String QR08 = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERITPICKPRJPOR'";
        ...
        if (filstrlocation==null) {
          ...
          if (LASTFILTERLOCATION!=null) {
            ...
            String QU03 = "UPDATE FILTER SET FILTERVALUE='"+filstrlocation+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERLOCATIONPICKPRJPOR'";
            STU03.executeUpdate(QU03);
            STU03.close();
          } else {
            Statement STU04 = Conn.createStatement();
            String QU04 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERLOCATIONPICKPRJPOR','"+filstrlocation+"')";
        ...
        if (filstrdivision==null) {
          ...
          if (LASTFILTERDIVISION!=null) {
            ...
            String QU05 = "UPDATE FILTER SET FILTERVALUE='"+filstrdivision+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERDIVISIONPICKPRJPOR'";
            STU05.executeUpdate(QU05);
            STU05.close();
          } else {
            Statement STU06 = Conn.createStatement();
            String QU06 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERDIVISIONPICKPRJPOR','"+filstrdivision+"')";
        ...
        if (filstrBPO==null) {
          ...
          if (LASTFILTERBPO!=null) {
            ...
            String QU07 = "UPDATE FILTER SET FILTERVALUE='"+filstrBPO+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERBPOPICKPRJPOR'";
            STU07.executeUpdate(QU07);
            STU07.close();
          } else {
            Statement STU08 = Conn.createStatement();
            String QU08 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERBPOPICKPRJPOR','"+filstrBPO+"')";
        ...
        if (filstrPM==null) {
          ...
          if (LASTFILTERPM!=null) {
            ...
            String QU09 = "UPDATE FILTER SET FILTERVALUE='"+filstrPM+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERPMPICKPRJPOR'";
            STU09.executeUpdate(QU09);
            STU09.close();
          } else {
            Statement STU10 = Conn.createStatement();
            String QU10 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERPMPICKPRJPOR','"+filstrPM+"')";
        ...
        if (filstrSI==null) {
          ...
          if (LASTFILTERSI!=null) {
            ...
            String QU11 = "UPDATE FILTER SET FILTERVALUE='"+filstrSI+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERSIPICKPRJPOR'";
            STU11.executeUpdate(QU11);
            STU11.close();
          } else {
            Statement STU12 = Conn.createStatement();
            String QU12 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERSIPICKPRJPOR','"+filstrSI+"')";
        ...
        if (filstrAT==null) {
          ...
          if (LASTFILTERAT!=null) {
            ...
            String QU13 = "UPDATE FILTER SET FILTERVALUE='"+filstrAT+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERATPICKPRJPOR'";
            STU13.executeUpdate(QU13);
            STU13.close();
          } else {
            Statement STU14 = Conn.createStatement();
            String QU14 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERATPICKPRJPOR','"+filstrAT+"')";
        ...
        if (filstrIT==null) {
          ...
          if (LASTFILTERIT!=null) {
            ...
            String QU15 = "UPDATE FILTER SET FILTERVALUE='"+filstrIT+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERITPICKPRJPOR'";
            STU15.executeUpdate(QU15);
            STU15.close();
          } else {
            Statement STU16 = Conn.createStatement();
            String QU16 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERITPICKPRJPOR','"+filstrIT+"')";
        ...
        String q230 = "SELECT COUNT(ID) FROM PROJECT WHERE "+filterstatement+" ID NOT IN (SELECT PROJECTID FROM PRJPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"') AND STATUS<>'REQUEST'";
        ...
        for (int i=0; i<=nbpage;i++) {
          out.print("<td><A HREF=\"pickportfolioproject.jsp?TODO=ADD&PAGE="+i+"&PORTFOLIOID="+PORTFOLIOID+"\">"+i+"</A></td>");
        }
        out.print("</tr></table>");
        ...
        String QR01 = "SELECT ID,NAME FROM PROJECT WHERE "+filterstatement+" ID NOT IN (SELECT PROJECTID FROM PRJPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"') AND STATUS<>'REQUEST'";
        ...
        while(R01.next()) {
          if (pagecount>=PAGE*20 && pagecount<(PAGE+1)*20) {
            out.print("<tr>");
            out.print("<td>&nbsp;</td>");
            out.print("<td bgcolor=\"#FFFFFF\"><A HREF=\"portfolioproject.jsp?TODO=ADD&PROJECTID="+R01.getString("ID")+"&PORTFOLIOID="+PORTFOLIOID+"\">"+R01.getString("NAME")+"</td>");
            out.print("<td>&nbsp;</td>");
            out.print("</tr>");
          }
          pagecount++;
        ...
        STR01.close();
        out.print("</table>");
        out.print("<A HREF=\"portfolioproject.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\"><img border=0 src=\"icons/cancel.png\"></A>");
        Conn.close();
      }
