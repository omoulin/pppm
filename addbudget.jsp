    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {  
          ...
          out.print("<center><table><tr><td><img border=0 src=\"icons/financials.png\"></td><td><strong><h1>Modify project issue</h1></strong></td></tr></table></center><hr>");
        }
        out.print("<hr>");
        String DESCRIPTION = "";
        String TYPE = "";
        ...
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectbudget.jsp?TODO=BUDADD&PROJECTID="+PROJECTID+"\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectbudget.jsp?TODO=BUDMOD&PROJECTID="+PROJECTID+"&BUDGETID="+BUDGETID+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,DESCRIPTION,TYPE,AMOUNT,DATEBUD,CER FROM PROJECT_BUDGET WHERE PROJECTID='"+PROJECTID+"' AND ID="+BUDGETID;
        ...
        if (act.equals("ADD")) {
          ...
          out.print("<td><A HREF=\"projectbudget.jsp?TODO=NONE&PROJECTID="+PROJECTID+"\"><img border=0 src=\"icons/cancel.png\"></A></td></tr></table>");
        } else {  
