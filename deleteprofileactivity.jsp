  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"resourcesactivity.jsp?TODO=PRODELETE&PROFILEID="+PROFILEID+"&PROJECTID="+PROJECTID+"&ACTIVITYID="+ACTIVITYID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        STR03.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this profile from this activity on this project ??</H1></td><td>&nbsp;</td></tr>");
