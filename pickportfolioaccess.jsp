  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("You are here : Portfolio \\ <A HREF=\"portconfig.jsp?TODO=NONE\" target=\"appliFrame\"> Portfolio configuration</A> \\ <A HREF=\"portfolioaccess.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\" target=\"appliFrame\">Portfolio access</A> \\ Add access");
        out.print("<hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"pickportfolioaccess.jsp?TODO=FILTER&FILTER=FILTER&PORTFOLIOID="+PORTFOLIOID+"&PAGE=0\" target=\"appliFrame\">");
        String LASTFILTERNAME=null;
        Statement st123b = Conn.createStatement();
        String q123b = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERNAMEPICKPORTACC'";
        ...
        String q123c = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERFORNAMEPICKPORTACC'";
        ...
        if (filstrNAME==null) {
          ...
          if (LASTFILTERNAME!=null) {
            ...
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrNAME+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERNAMEPICKPORTACC'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERNAMEPICKPORTACC','"+filstrNAME+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        if (filstrFORNAME==null) {
          ...
          if (LASTFILTERFORNAME!=null) {
            Statement sti2 = Conn.createStatement();
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrFORNAME+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERFORNAMEPICKPORTACC'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERFORNAMEPICKPORTACC','"+filstrFORNAME+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        ...
        String q230 = "SELECT COUNT(LOGIN) FROM USERS WHERE "+filterstatement+" LOGIN NOT IN (SELECT LOGIN FROM USRPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"')";
        ResultSet r230 = st230.executeQuery(q230);
        if (r230.next()) {    
          nbpage=r230.getInt("COUNT(LOGIN)")/20;
        }
        st230.close();
        String NAME = "";
        out.print("<table><tr><td>Page : </td>");
        for (int i=0; i<=nbpage;i++) {
          out.print("<td><A HREF=\"pickportfolioaccess.jsp?TODO=ADD&PAGE="+i+"&PORTFOLIOID="+PORTFOLIOID+"\">"+i+"</A></td>");
        }
        out.print("</tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        out.print("<td width=\"10%\">&nbsp;</td>");
        out.print("<td width=\"80%\" background=\"images/fond_titre.jpg\"><center>Person to give management on the portfolio</center></td>");
        out.print("<td width=\"10%\">&nbsp;</td>");
        out.print("</tr>");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT LOGIN,NAME,FORNAME FROM USERS WHERE "+filterstatement+" LOGIN NOT IN (SELECT LOGIN FROM USRPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"')";
        ...
        while(R01.next()) {
          if (pagecount>=PAGE*20 && pagecount<(PAGE+1)*20) {
            out.print("<tr>");
            out.print("<td>&nbsp;</td>");
            out.print("<td bgcolor=\"#FFFFFF\"><A HREF=\"portfolioaccess.jsp?TODO=ADD&LOGIN="+R01.getString("LOGIN")+"&PORTFOLIOID="+PORTFOLIOID+"\">"+R01.getString("NAME")+" "+R01.getString("FORNAME")+"</td>");
            out.print("<td>&nbsp;</td>");
            out.print("</tr>");
          }
          pagecount++;
        ...
        STR01.close();
        out.print("</table>");
        out.print("<A HREF=\"portfolioaccess.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\"><img border=0 src=\"icons/cancel.png\"></A>");
        Conn.close();
      }
