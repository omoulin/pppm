  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectbudget.jsp?TODO=EXPADD&PROJECTID="+PROJECTID+"\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectbudget.jsp?TODO=EXPMOD&PROJECTID="+PROJECTID+"&EXPENSEID="+EXPENSEID+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,DESCRIPTION,TYPE,AMOUNT,DATEEXP,INVOICE,VENDORID FROM PROJECT_EXPENSE WHERE PROJECTID='"+PROJECTID+"' AND ID="+EXPENSEID;
