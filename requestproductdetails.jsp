  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<table><tr><td>You are here : Request management \\ <A HREF=\"request.jsp?TODO=NONE\" target=\"appliFrame\"> Request(s)</A> \\ Request details<td><A HREF=\"requestproductdetails.jsp?TODO=NONE&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/reload.png\"></A></td></tr></table>");
        out.print("<hr>");
        out.print("<table><tr><td><h2><strong>Request description</strong></h2></center></td><td><A HREF=\"addrequest.jsp?TODO=MOD&REQ=Y&PRODUCTID="+PRODUCTID+"&REQTYPE=PRODUCT\"><img border=0 src=\"icons/modify.png\"></A></td></tr></table>");
        ...
        out.print("<td><A HREF=\"pickproductstrategicinitiative.jsp?TODO=ADD&REQ=Y&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        out.print("</tr></table>");
        ...
        while(r30.next()) {
          ...
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"deleteproductstrategicinitiative.jsp?TODO=DELETE&REQ=Y&SIID="+r30.getString("ID")+"&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          } else {
        ...
        st30.close();
        out.print("</table>");
        out.print("<hr><table><tr><td><h2><strong>Product Owner(s)</strong></h2></center></td>");
        out.print("<td><A HREF=\"pickproductbpo.jsp?TODO=ADD&REQ=Y&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        out.print("</tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        ...
        while(r30.next()) {
          ...
          out.print("<td><center><A HREF=\"deleteproductbpo.jsp?TODO=DELETE&REQ=Y&EMPLOYEEID="+r30.getString("ID")+"&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          out.print("</tr>");
        }
        st30.close();
        out.print("</table>");
        ...
        out.print("<td><A HREF=\"pickproductdivision.jsp?TODO=ADD&REQ=Y&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        out.print("</tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        out.print("<td width=\"90%\" background=\"images/fond_titre.jpg\"><center>Name</center></td>");
        ...
        while(r30.next()) {
          out.print("<tr>");
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+r30.getString("NAME")+"</center></A></td>");
          out.print("<td><center><A HREF=\"deleteproductdivision.jsp?TODO=DELETE&REQ=Y&DIVISIONID="+r30.getString("ID")+"&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          out.print("</tr>");
        }
        st30.close();
        out.print("</table>");
        out.print("<hr><table><tr><td><h2><strong>Location(s) impacted</strong></h2></center></td>");
        out.print("<td><A HREF=\"pickproductlocation.jsp?TODO=ADD&REQ=Y&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td>");
        out.print("</tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        out.print("<td width=\"90%\" background=\"images/fond_titre.jpg\"><center>Name</center></td>");
        ...
        while(r30.next()) {
          out.print("<tr>");
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+r30.getString("NAME")+"</center></A></td>");
          out.print("<td><center><A HREF=\"deleteproductlocation.jsp?TODO=DELETE&REQ=Y&LOCATIONID="+r30.getString("ID")+"&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          out.print("</tr>");
        }
        st30.close();
        out.print("</table>");
