...
<html>
  ...
  <body background="images/fond.gif">
    <%
      ...
      String QR01 = "SELECT NAME FROM PROGRAM WHERE ID='"+PROGRAMID+"'";
      ...
      String QR02 = "SELECT ID,NAME,DATE_DISCOVER,DATE_CLOSING,IMPACT,LIKELIHOOD,CLOSED,PROJECTID FROM PROJECT_RISK WHERE PROJECTID IN (SELECT PROJECTID FROM PRJPGM WHERE PROGRAMID='"+PROGRAMID+"')";
      ...
      while (R02.next()) {
        if (risk_matrix[R02.getInt("IMPACT")][R02.getInt("LIKELIHOOD")].equals(level)) {
          ...
          String QR03 = "SELECT NAME FROM PROJECT WHERE ID='"+R02.getString("PROJECTID")+"'";
          ResultSet R03 = STR03.executeQuery(QR03);
          if (R03.next()) {
            out.print("<td><center>"+R03.getString("NAME")+"</center></td>");
          } else {
