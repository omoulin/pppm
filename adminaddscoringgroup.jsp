  ...
  <body background="images/fond.gif">
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          GROUPID="";
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"adminscoring.jsp?TODO=GRPADD\" target=\"appliFrame\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"adminscoring.jsp?TODO=GRPMOD&GROUPID="+GROUPID+"\" target=\"appliFrame\">");
        }
        if (act.equals("MOD")) {
        ...
        out.print("<table>");
        if (act.equals("ADD")) {
          out.print("<tr><td>ID : </td><td><input name=\"GROUPID\" type=\"text\" size=\"50\" value=\"\"></td></tr>");
        }   
