...
<%!public void generatePlanning(String planningProductID,String FATHERID,int level,String RO,Connection planningConnection,JspWriter out) throws Exception {
  Statement st31 = planningConnection.createStatement();  
  String q31 = "SELECT NAME,DATE_START,DATE_END,ID,WORKLOAD,DURATION,TEMPLATELINK,DOCLINK FROM PRODUCT_ACTIVITY WHERE PRODUCTID='"+planningProductID+"' AND FATHER='"+FATHERID+"' ORDER BY ORD ASC";
  ResultSet r31 = st31.executeQuery(q31);
  while(r31.next()) {   
    out.print("<tr>");
    out.print("<td><table><tr>");
    if (RO.equals("NO")) {
      out.print("<td><center><A HREF=\"addproductactivity.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&FATHER="+r31.getInt("ID")+"\"><img border=0 src=\"icons/addsmall.png\"></A></center></td>");
      out.print("<td><center><A HREF=\"deleteproductactivity.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&ID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/deletesmall.png\"></A></center></td>");
      out.print("<td><center><A HREF=\"linkproductactivity.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&FROMID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/linksmall.png\"></A></center></td>");
      out.print("<td><center><A HREF=\"deleteproductactivitylink.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/deletelinksmall.png\"></A></center></td>");
    }
    ...
    String q43 = "SELECT * FROM PRODUCT_ACTIVITY WHERE PRODUCTID='"+planningProductID+"' AND FATHER="+r31.getString("ID");
    ...
    if (RO.equals("NO")) {
      if (cansplit) {
        out.print("<td width=\"20%\"><A HREF=\"addproductactivity.jsp?TODO=MOD&PRODUCTID="+planningProductID+"&ID="+r31.getInt("ID")+"&NAMEONLY=FALSE\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
      } else {
        out.print("<td width=\"20%\"><A HREF=\"addproductactivity.jsp?TODO=MOD&PRODUCTID="+planningProductID+"&ID="+r31.getInt("ID")+"&NAMEONLY=TRUE\"><img border=0 src=\"icons/modifysmall.png\"></A></td>");
      }
    }
    ...
    q43 = "SELECT WORKLOAD FROM PRODUCT_ACTIVITY_WORKLOAD WHERE PRODUCTID='"+planningProductID+"' AND ACTIVITYID="+r31.getString("ID");
    ...
    if (wrkl!=r31.getInt("WORKLOAD")) {
      if (cansplit) {
        ...
        Product pl = new Product(planningConnection,planningProductID);
      ...
      if (RO.equals("NO") && cansplit) {
        out.print("<td width=\"20%\"><A HREF=\"productsplitactivityworkload.jsp?TODO=MOD&PRODUCTID="+planningProductID+"&ID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/splitsmall.png\"></A></td>");
      }
      if (cansplit) {
        out.print("<td bgcolor=\"#FFFFFF\"><table width=\"100%\"><tr><td width=\"60%\"><center>"+r31.getInt("WORKLOAD")+"</td>");
      } else {
    ...
    String q33 = "SELECT PERCENTAGE FROM PRODUCT_RESOURCE_PROFILE_ACTIVITY WHERE PRODUCTID='"+planningProductID+"' AND ACTIVITYID="+r31.getString("ID");
    ...
    q33 = "SELECT PERCENTAGE FROM PRODUCT_RESOURCE_USER_ACTIVITY WHERE PRODUCTID='"+planningProductID+"' AND ACTIVITYID="+r31.getString("ID")+" AND APPROVED='YES'";
    ...
    if (RO.equals("NO")) {
      if (percenttotal2!=100) {
        out.print("<td bgcolor=\"#FFFFFF\"><center><table width=\"100%\"><tr><td width=\"70%\"><center><A HREF=\"productresourcesactivity.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/resourcessmall.png\"></A></center></td><td width=\"30%\"><center><img border=0 src=\"icons/alertsmall.png\"></center></td></tr></table></center></td>");
      } else {  
        out.print("<td bgcolor=\"#FFFFFF\"><center><table width=\"100%\"><tr><td width=\"70%\"><center><A HREF=\"productresourcesactivity.jsp?TODO=ADD&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/resourcessmall.png\"></A></center></td><td width=\"30%\">&nbsp;</td></tr></table></center></td>");
      }
    } else {
      out.print("<td bgcolor=\"#FFFFFF\"><center>-</center></td>");
    }
    st33 = planningConnection.createStatement();
    q33 = "SELECT * FROM PRODUCT_ACTIVITY_LINK WHERE PRODUCTID='"+planningProductID+"' AND FROMID="+r31.getString("ID");
    r33 = st33.executeQuery(q33);
    ...
    if (RO.equals("NO")) {
      if (r31.getString("DOCLINK")==null) {
        out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"productadddoc.jsp?TODO=ADDDOC&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/docaddsmall.png\"></A></center></A></td>");
      } else {
        if (r31.getString("DOCLINK").equals("")) {
          out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"productadddoc.jsp?TODO=ADDDOC&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/docaddsmall.png\"></A></center></A></td>");
        } else {
          out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\""+r31.getString("DOCLINK")+"\" target=\"_new\"><img border=0 src=\"icons/docsmall.png\"></A><A HREF=\"productadddoc.jsp?TODO=MODDOC&PRODUCTID="+planningProductID+"&ACTIVITYID="+r31.getInt("ID")+"\"><img border=0 src=\"icons/modifysmall.png\"></A></center></A></td>");
        }
      }
    } else {
    ...
    if (cansplit) {
      ...
      String i2 = "UPDATE PRODUCT_ACTIVITY SET DATE_START='"+sd+"',DATE_END='"+ed+"' WHERE PRODUCTID='"+planningProductID+"' AND ID="+r31.getString("ID");
      sti2.executeUpdate(i2);
    }
    out.print("</tr>");    
    generatePlanning(planningProductID,r31.getString("ID"),level+1,RO,planningConnection,out); 
  }
  st31.close();
}
%>
<%!public void displayPlanning(String planningProductID,String FATHERID,int level,String RO,Connection planningConnection,JspWriter out) {
  try {
    generatePlanning(planningProductID,FATHERID,level,RO,planningConnection,out);
  } catch (Exception e) {
  }
} 
%>
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        Product pl = new Product(Conn,PRODUCTID);
        ...
        if (act.equals("SPLIT")) {
          ...
          String q100 = "SELECT YEAR,MONTH,DAY,WORKLOAD FROM PRODUCT_ACTIVITY_WORKLOAD WHERE ACTIVITYID='"+ID+"' AND PRODUCTID='"+PRODUCTID+"' ORDER BY YEAR,MONTH,DAY";
        ...
        out.print("<center><table><tr><td><img border=0 src=\"icons/planning.png\"></td><td><strong><h1>Product planning</h1></strong></td></tr></table></center><hr>");
        if (RO.equals("NO")) {
          out.print("<td><A HREF=\"productloadmsp.jsp?TODO=NONE&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/load.png\"> </A></td>");
          User us = new User(Conn);
          if (us.hasRole(Userlogin,"BASELINE")) {
            out.print("<td><A HREF=\"addproductbaseline.jsp?TODO=NONE&PRODUCTID="+PRODUCTID+"\"><img border=0 src=\"icons/addbaseline.png\"> </A></td>");
          }
        }
        out.print("<td><A HREF=\"productbaseline.jsp?TODO=NONE&PRODUCTID="+PRODUCTID+"&RO="+RO+"\"><img border=0 src=\"icons/baseline.png\"> </A></td>");
        out.print("</tr></table>");
        out.print("<hr>");
        ...
        String q30 = "SELECT NAME,DATE_START,DATE_END,ID FROM PRODUCT_ACTIVITY WHERE PRODUCTID='"+PRODUCTID+"' AND FATHER='ROOT' ORDER BY ORD ASC";
        ResultSet r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr>");
          out.print("<td><table><tr>");
          if (RO.equals("NO")) {
            out.print("<td><center><A HREF=\"addproductactivity.jsp?TODO=ADD&PRODUCTID="+PRODUCTID+"&FATHER="+r30.getInt("ID")+"\"><img border=0 src=\"icons/addsmall.png\"></A></center></td>");
          } else {
            out.print("<td>&nbsp;</td>");
          }
          ...
          String q31b = "SELECT WORKLOAD FROM PRODUCT_ACTIVITY WHERE PRODUCTID='"+PRODUCTID+"' AND FATHER='"+r30.getInt("ID")+"' ORDER BY ORD ASC";
          ...
          out.print("<td bgcolor=\"#EFEFEF\"><center><table width=\"100%\"><tr><td width=\"70%\"><center><A HREF=\"productresourcesactivity.jsp?TODO=ADD&PRODUCTID="+PRODUCTID+"&ACTIVITYID="+r30.getInt("ID")+"\"><img border=0 src=\"icons/resourcessmall.png\"></A></center></td><td width=\"30%\">&nbsp;</td></tr></table></center></td>");
          st31b = Conn.createStatement();
          q31b = "SELECT * FROM PRODUCT_ACTIVITY_LINK WHERE PRODUCTID='"+PRODUCTID+"' AND FROMID="+r30.getString("ID");
          ...
          String q30a = "SELECT ID FROM PRODUCT_ACTIVITY WHERE PRODUCTID='"+PRODUCTID+"' AND FATHER='"+r30.getString("ID")+"'";
          ...
          out.print("</tr>");
          displayPlanning(PRODUCTID,r30.getString("ID"),1,RO,Conn,out);
        }
        st30.close();
        out.print("</table>");
