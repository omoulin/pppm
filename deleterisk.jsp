  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectrisk.jsp?TODO=RSKDELETE&RISKID="+RISKID+"&PROJECTID="+PROJECTID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        out.print("<input type=button onClick=\"location.href='projectrisk.jsp?TODO=NONE&PROJECTID="+PROJECTID+"'\" value='Cancel'></td></tr>");
        out.print("</table>");
        out.print("</form>");
        Conn.close();
      }
