  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationbudget.jsp?TODO=EXPADD&APPLICATIONID="+APPLICATIONID+"\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationbudget.jsp?TODO=EXPMOD&APPLICATIONID="+APPLICATIONID+"&EXPENSEID="+EXPENSEID+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,DESCRIPTION,TYPE,AMOUNT,DATEEXP,INVOICE,VENDORID FROM APPLICATION_EXPENSE WHERE APPLICATIONID='"+APPLICATIONID+"' AND ID="+EXPENSEID;
