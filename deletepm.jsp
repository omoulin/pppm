    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        String PROJECTID = request.getParameter("PROJECTID");
      	out.print("<center><strong><h1>Project Manager delete approval</h1></strong></center><hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectdetails.jsp?TODO=PMDELETE&EMPLOYEEID="+EMPLOYEEID+"&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">");
        out.print("<table>");
        ...
        STR02.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this PM from this project ??</H1></td><td>&nbsp;</td></tr>");
