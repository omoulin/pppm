      ...
      String Userlogin = (String)session.getAttribute("LOGIN");
       ...
       if (Userlogin==null) {
        ...
        if (ptmp==null) {
      	...
      	out.print("<center><strong><h1>Products(s)</h1></strong></center><hr>");
        out.print("You are here : Portfolio \\ <A HREF=\"portconfig.jsp?TODO=NONE\" target=\"appliFrame\"> Portfolio configuration</A> \\ <A HREF=\"portfolioproduct.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\" target=\"appliFrame\">Portfolio product(s)</A> \\ Add Product");
        out.print("<hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"pickportfolioproduct.jsp?TODO=FILTER&FILTER=FILTER&PORTFOLIOID="+PORTFOLIOID+"&PAGE=0\" target=\"appliFrame\">");
        String LASTFILTERBPO=null;
        Statement st123b = Conn.createStatement();
        String q123b = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERBPOPRDPICK'";
        ...
        String q123c = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERPMPRDPICK'";
        ...
        if (filstrBPO==null) {
          ...
          if (LASTFILTERBPO!=null) {
            ...
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrBPO+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERBPOPRDPICK'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERBPOPRDPICK','"+filstrBPO+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        if (filstrPM==null) {
          ...
          if (LASTFILTERPM!=null) {
            Statement sti2 = Conn.createStatement();
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrPM+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERPMPRDPICK'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERPMPRDPICK','"+filstrPM+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        ...
        out.print("Product Owner : <select name=\"SELECTFILTERBPO\">");
        ...
        out.print("</td>");
        out.print("<td bgcolor=#FFFFFF>");
        out.print("Product Manager : <select name=\"SELECTFILTERPM\">");
        out.print("<option>*** - ALL</option>");
        ...
        if (filter!= null) {
          ...
          if (!idfilBPO.equals("***")) {
            ...
            filterstatement = filterstatement + "ID in (SELECT PRODUCTID FROM PRDBPO WHERE EMPLOYEEID='"+idfilBPO+"')";
            first = false;
          }
          ...
          if (!idfilPM.equals("***")) {
            ...
            filterstatement = filterstatement + "ID in (SELECT PRODUCTID FROM PRDPM WHERE EMPLOYEEID='"+idfilPM+"')";
            first = false;
          }
        }
        if (first) {
        ...
        String q230 = "SELECT COUNT(ID) FROM PRODUCT "+filterstatement+" ID NOT IN (SELECT PRODUCTID FROM PRDPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"')";
        ...
        for (int i=0; i<=nbpage;i++) {
          out.print("<td><A HREF=\"pickportfolioproduct.jsp?TODO=ADD&PAGE="+i+"&PORTFOLIOID="+PORTFOLIOID+"\">"+i+"</A></td>");
        }
        out.print("</tr></table>");
        ...
        String QR01 = "SELECT ID,NAME FROM PRODUCT "+filterstatement+" ID NOT IN (SELECT PRODUCTID FROM PRDPOR WHERE PORTFOLIOID='"+PORTFOLIOID+"')";
        ...
        while(R01.next()) {
          if (pagecount>=PAGE*20 && pagecount<(PAGE+1)*20) {
            out.print("<tr>");
            out.print("<td>&nbsp;</td>");          
            out.print("<td bgcolor=\"#FFFFFF\"><A HREF=\"portfolioproduct.jsp?TODO=ADD&PRODUCTID="+R01.getString("ID")+"&PORTFOLIOID="+PORTFOLIOID+"\">"+R01.getString("NAME")+"</td>");
            out.print("<td>&nbsp;</td>");          
            out.print("<tr>");
          }
          pagecount++;
        ...
        STR01.close();
        out.print("</table>");
        out.print("<A HREF=\"portfolioproduct.jsp?TODO=NONE&PORTFOLIOID="+PORTFOLIOID+"\"><img border=0 src=\"icons/cancel.png\"></A>");
        Conn.close();
      }
