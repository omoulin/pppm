  ...
  <body background="images/fond.gif">
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectresources.jsp?TODO=RESADD&EMPLOYEEID="+EMPLOYEEID+"&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">");
        out.print("<table>");
        out.print("<tr><td>Workload (hours per month) : </td><td><input name=\"WORKLOAD\" type=\"text\" size=\"50\" value=\"0\"></td></tr>");
        out.print("<tr><td>Date start: </td><td><input name=\"DATE_START\" type=\"text\" size=\"50\" value=\""+DATE_START+"\" readonly=\"readonly\">");  
        out.print("<script language=\"JavaScript\"> new tcal ({'formname': 'formFILTER','controlname': 'DATE_START'}); </script></td></tr>");
        out.print("<tr><td>Date end: </td><td><input name=\"DATE_END\" type=\"text\" size=\"50\" value=\""+DATE_END+"\" readonly=\"readonly\">");  
        out.print("<script language=\"JavaScript\"> new tcal ({'formname': 'formFILTER','controlname': 'DATE_END'}); </script></td></tr>");
        out.print("<table><tr><td>&nbsp;</td><td><INPUT border=0 src=\"icons/add.png\" type=image Value=submit></td>");
        out.print("<td><A HREF=\"projectresources.jsp?TODO=NONE&PROJECTID="+PROJECTID+"\"><img border=0 src=\"icons/cancel.png\"></A></td></tr></table>");
        out.print("</table>");
        out.print("</form>");
        Conn.close();
      }
