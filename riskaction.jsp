      ...
      if (Userlogin==null) {
        ...
        risk_matrix[5][1]="O";
          ...
          if (!are_date_valid) {
            ...
            String q43 = "SELECT ID FROM PROJECT_RISK_ACTION WHERE PROJECTID='"+PROJECTID+"' AND RISKID='"+RISKID+"' ORDER BY ID DESC";
            ...
            String i2 = "INSERT INTO PROJECT_RISK_ACTION VALUES('"+PROJECTID+"',"+RISKID+","+ORD+",'"+checkstr(request.getParameter("NAME"))+"','"+checkstr(request.getParameter("DESCRIPTION"))+"','"+request.getParameter("DATE_CREATION")+"','"+request.getParameter("DATE_CLOSING")+"','"+checkstr(request.getParameter("STATUS"))+"','"+EMPLOYEEID+"',"+request.getParameter("IMPACT")+","+request.getParameter("LIKELIHOOD")+",'"+request.getParameter("IMPLEMENT")+"','"+CLOSED+"','"+request.getParameter("STRATEGY")+"')";
        ...
        if (act.equals("ACTMOD")) {
          ...
          if (!are_date_valid) {
            ...
            Statement sti2 = Conn.createStatement();
            String i2 = "UPDATE PROJECT_RISK_ACTION SET NAME='"+checkstr(request.getParameter("NAME"))+"',DESCRIPTION='"+checkstr(request.getParameter("DESCRIPTION"))+"',DATE_CREATION='"+request.getParameter("DATE_CREATION")+"',DATE_CLOSING='"+request.getParameter("DATE_CLOSING")+"',EMPLOYEEID='"+EMPLOYEEID+"',IMPACT="+request.getParameter("IMPACT")+",LIKELIHOOD="+request.getParameter("LIKELIHOOD")+",STATUS='"+checkstr(request.getParameter("STATUS"))+"',IMPLEMENT='"+request.getParameter("IMPLEMENT")+"',CLOSED='"+CLOSED+"',STRATEGY='"+checkstr(request.getParameter("STRATEGY"))+"' WHERE PROJECTID='"+PROJECTID+"' AND RISKID="+RISKID+" AND ID="+ACTIONID;
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        if (act.equals("ACTDELETE")) {
          String ACTIONID = request.getParameter("ACTIONID");
          Statement sti2 = Conn.createStatement();
          String i2 = "DELETE FROM PROJECT_RISK_ACTION WHERE RISKID="+RISKID+" AND PROJECTID='"+PROJECTID+"' AND ID="+ACTIONID;
          sti2.executeUpdate(i2);
          sti2.close();
        }
        out.print("<center><table><tr><td><img border=0 src=\"icons/risks.png\"></td><td><strong><h1>Response(s) to project risk</h1></strong></td></tr></table></center><hr>");
        ...
        out.print("<table><tr><td><h2><strong>Project risk</strong></h2></center></td></td></tr></table>");
        ...
        String q30 = "SELECT ID,PROJECTID,NAME,DESCRIPTION,DATE_DISCOVER,DATE_CLOSING,EMPLOYEEID,IMPACT,LIKELIHOOD,ESCALATE,CLOSED FROM PROJECT_RISK WHERE PROJECTID='"+PROJECTID+"' AND ID="+RISKID;
        ...
        st30.close();
        out.print("</table>");
        out.print("<br><hr><table><tr><td><h2><strong>Risk response(s)</strong></h2></center></td><td><A HREF=\"addaction.jsp?TODO=ADD&PROJECTID="+PROJECTID+"&RISKID="+RISKID+"\"><img border=0 src=\"icons/addsmall.png\"></A></td></tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        ...
        q30 = "SELECT ID,PROJECTID,RISKID,NAME,DESCRIPTION,DATE_CREATION,DATE_CLOSING,EMPLOYEEID,IMPACT,LIKELIHOOD,STATUS,IMPLEMENT,CLOSED,STRATEGY FROM PROJECT_RISK_ACTION WHERE PROJECTID='"+PROJECTID+"' AND RISKID='"+RISKID+"' ORDER BY "+COLTOSORT+" "+DIRSORT;
        r30 = st30.executeQuery(q30);
        while(r30.next()) {
          out.print("<tr>");
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+r30.getString("STRATEGY")+"</center></td>");
          out.print("<td bgcolor=\"#FFFFFF\"><table><tr><td>"+r30.getString("NAME")+"</td><td><center><A HREF=\"addaction.jsp?TODO=MOD&ACTIONID="+r30.getString("ID")+"&PROJECTID="+PROJECTID+"&RISKID="+RISKID+"\"><img border=0 src=\"icons/modifysmall.png\"></center></A></td></tr></table></td>");
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+r30.getString("IMPACT")+"</center></td>");
          out.print("<td bgcolor=\"#FFFFFF\"><center>"+r30.getString("LIKELIHOOD")+"</center></td>");
          int impact = r30.getInt("IMPACT");
          int likelihood = r30.getInt("LIKELIHOOD");
          ...
          out.print("<td><center><A HREF=\"deleteaction.jsp?TODO=DELETE&ACTIONID="+r30.getString("ID")+"&PROJECTID="+PROJECTID+"&RISKID="+RISKID+"\"><img border=0 src=\"icons/deletesmall.png\"></center></A></td>");
          out.print("</tr>");
        }
        st30.close();
        out.print("</table>");
        out.print("<br><center><A HREF=\"projectrisk.jsp?TODO=NONE&PROJECTID="+PROJECTID+"\">Return</A></center>");
        Conn.close();
      }
