    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        for (int i=0;i<=100; i=i+5) {
          out.print("<tr><td><A HREF=\"productresourcesactivity.jsp?TODO=PROPERCENT&PROFILEID="+PROFILEID+"&PRODUCTID="+PRODUCTID+"&ACTIVITYID="+ACTIVITYID+"&PERCENTAGE="+i+"\">"+i+"%</A></td></tr>");
        }
        out.print("</table>");
