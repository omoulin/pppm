  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        String QR01 = "SELECT PROJECTID,ACTIVITYID,DATE_START,DATE_END,WORKLOAD,DURATION,NAME FROM BASELINE_ACTIVITY WHERE PROJECTID='"+PROJECTID+"' AND BASELINEID="+BASELINEID;
        ...
        STR01.close();
        out.print("</table>");
        out.print("<br><center><A HREF=\"baseline.jsp?TODO=NONE&PROJECTID="+PROJECTID+"\">Return</A></center>");
        Conn.close();
      }
