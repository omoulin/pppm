  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        int ORD=0; 
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productplanning.jsp?TODO=ACTADD&PRODUCTID="+PRODUCTID+"&FATHER="+FATHER+"&NAMEONLY=FALSE\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productplanning.jsp?TODO=ACTMOD&PRODUCTID="+PRODUCTID+"&ID="+ID+"&NAMEONLY="+NAMEONLY+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,NAME,ORD,DATE_START,DATE_END,WORKLOAD FROM PRODUCT_ACTIVITY WHERE ID='"+ID+"' AND PRODUCTID='"+PRODUCTID+"'";
        ...
        if (NAMEONLY.equals("FALSE")) {
          ...
          if (act.equals("ADD")) {
            ...
            String QR02 = "SELECT ORD,NAME FROM PHASE_TEMPLATE_ACTIVITY WHERE TEMPLATE IN (SELECT TEMPLATE FROM PRODUCT WHERE ID='"+PRODUCTID+"')";
