  ...
  <body background="images/fond.gif">
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<center><strong><h1>Program Manager delete approval</h1></strong></center><hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"programdetails.jsp?TODO=PMDELETE&EMPLOYEEID="+EMPLOYEEID+"&PROGRAMID="+PROGRAMID+"\" target=\"appliFrame\">");
        out.print("<table>");
