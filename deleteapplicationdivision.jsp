    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<center><strong><h1>Delete division</h1></strong></center><hr>");
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationdetails.jsp?TODO=DIVDELETE&DIVISIONID="+DIVISIONID+"&APPLICATIONID="+APPLICATIONID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        STR02.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this division from this application ??</H1></td><td>&nbsp;</td></tr>");
