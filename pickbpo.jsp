    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (ptmp==null) {
      	...
      	out.print("<center><strong><h1>Business Process Owners</h1></strong></center><hr>");
        out.print("You are here : Portfolio \\ <A HREF=\"portfolio.jsp?TODO=NONE\" target=\"appliFrame\"> Projects</A> \\ <A HREF=\"projectdetails.jsp?TODO=NONE&PROJECTID="+PROJECTID+"\" target=\"appliFrame\">Project details</A> \\ Add BPO");
        out.print("<hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"pickbpo.jsp?TODO=FILTER&FILTER=FILTER&PROJECTID="+PROJECTID+"&REQ="+REQ+"&PAGE=0\" target=\"appliFrame\">");
        String LASTFILTERNAME=null;
        Statement st123b = Conn.createStatement();
        String q123b = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERNAMEPICKBPO'";
        ...
        String q123c = "SELECT FILTERVALUE FROM FILTER WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERFORNAMEPICKBPO'";
        ...
        if (filstrNAME==null) {
          ...
          if (LASTFILTERNAME!=null) {
            ...
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrNAME+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERNAMEPICKBPO'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERNAMEPICKBPO','"+filstrNAME+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        if (filstrFORNAME==null) {
          ...
          if (LASTFILTERFORNAME!=null) {
            Statement sti2 = Conn.createStatement();
            String i2 = "UPDATE FILTER SET FILTERVALUE='"+filstrFORNAME+"' WHERE LOGIN='"+Userlogin+"' AND FILTERNAME='LASTFILTERFORNAMEPICKBPO'";
            sti2.executeUpdate(i2);
            sti2.close();
          } else {
            Statement sti2 = Conn.createStatement();
            String i2 = "INSERT INTO FILTER VALUES('"+Userlogin+"','LASTFILTERFORNAMEPICKBPO','"+filstrFORNAME+"')";
            sti2.executeUpdate(i2);
            sti2.close();
          }
        }
        ...
        String q230 = "SELECT COUNT(ID) FROM EMPLOYEE WHERE "+filterstatement+" ID NOT IN (SELECT EMPLOYEEID FROM PRJBPO WHERE PROJECTID='"+PROJECTID+"')";
        ...
        for (int i=0; i<=nbpage;i++) {
          out.print("<td><A HREF=\"pickbpo.jsp?TODO=ADD&PAGE="+i+"&PROJECTID="+PROJECTID+"&REQ="+REQ+"\">"+i+"</A></td>");
        }
        out.print("</tr></table>");
        out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
        out.print("<tr height=\"30\">");
        out.print("<td width=\"10%\">&nbsp;</td>");
        out.print("<td width=\"80%\" background=\"images/fond_titre.jpg\"><center>Business Process Owner</center></td>");
        out.print("<td width=\"10%\">&nbsp;</td>");
        out.print("</tr>");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT ID,NAME,FORNAME FROM EMPLOYEE WHERE "+filterstatement+" ID NOT IN (SELECT EMPLOYEEID FROM PRJBPO WHERE PROJECTID='"+PROJECTID+"')";
        ...
        while(R01.next()) {
          if (pagecount>=PAGE*20 && pagecount<(PAGE+1)*20) {
            ...
            out.print("<td>&nbsp;</td>");
            if (REQ.equals("N")) {
              out.print("<td bgcolor=\"#FFFFFF\"><A HREF=\"projectdetails.jsp?TODO=BPOADD&ID="+R01.getString("ID")+"&PROJECTID="+PROJECTID+"\">"+R01.getString("NAME")+" "+R01.getString("FORNAME")+"</td>");
            } else {
              out.print("<td bgcolor=\"#FFFFFF\"><A HREF=\"requestdetails.jsp?TODO=BPOADD&ID="+R01.getString("ID")+"&PROJECTID="+PROJECTID+"\">"+R01.getString("NAME")+" "+R01.getString("FORNAME")+"</td>");
            }
            out.print("<td>&nbsp;</td>");
            out.print("</tr>");
          }
