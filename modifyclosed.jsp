    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        String PROJECTID = request.getParameter("PROJECTID");
      	out.print("<hr>");
        String CLOSED = "";
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectdetails.jsp?TODO=CLOSED&PROJECTID="+PROJECTID+"\" target=\"_top\">");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT CLOSED FROM PROJECT WHERE ID='"+PROJECTID+"'";
