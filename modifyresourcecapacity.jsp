    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        String EMPLOYEEID = request.getParameter("EMPLOYEEID");
      	out.print("<hr>");
        String CAPACITY = "";
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"resourcecapacity.jsp?TODO=CAPMOD&EMPLOYEEID="+EMPLOYEEID+"\" target=\"_top\">");
        Statement STR01 = Conn.createStatement();
        String QR01 = "SELECT CAPACITY FROM EMPLOYEE WHERE ID='"+EMPLOYEEID+"'";
        ResultSet R01 = STR01.executeQuery(QR01);
        if (R01.next()) {
          CAPACITY=R01.getString("CAPACITY");
        }
        STR01.close();
        out.print("<table>");

        out.print("<tr><td>Capacity (h/month) : </td><td><input name=\"CAPACITY\" type=\"text\" size=\"50\" value=\""+CAPACITY+"\"></td></tr>");
