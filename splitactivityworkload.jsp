    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        String ID = request.getParameter("ID");
      	out.print("<hr>");
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"projectplanning.jsp?TODO=SPLIT&PROJECTID="+PROJECTID+"&ID="+ID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        String q10 = "SELECT YEAR,MONTH,DAY,WORKLOAD FROM PROJECT_ACTIVITY_WORKLOAD WHERE ACTIVITYID='"+ID+"' AND PROJECTID='"+PROJECTID+"' ORDER BY YEAR,MONTH,DAY";
