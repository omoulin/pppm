...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEW")) {
    out.print("<center><strong><h1>New other</h1></strong></center><hr>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"other.jsp?TODO=NEW\" target=\"appliFrame\">");
  } else {
    out.print("<center><strong><h1>Modify other</h1></strong></center><hr>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"other.jsp?TODO=MOD&ID="+ID+"\" target=\"appliFrame\">");
    Statement st30 = Conn.createStatement();
    String q30 = "SELECT * FROM CMDB_OTHER WHERE ID='"+ID+"'";
  ...
  if (act.equals("NEW")) {
    out.print("<tr><td>Name of the component : </td><td><input name=\"ID\" type=\"text\" size=\"50\" value=\""+ID+"\"></td></tr>");
  } else {
    out.print("<tr><td>Name of the component : </td><td>"+ID+"</td></tr>");
  }
  out.print("<tr><td>Description of the component : </td><td><textarea name=\"DESCRIPTION\" cols=\"80\" rows=\"25\" value=\"\">"+DESCRIPTION+"</textarea></td></tr>");
