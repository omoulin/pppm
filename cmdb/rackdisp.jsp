...
if (Userlogin==null) {
  ...
  out.print("<center><strong><h1>Rack "+ID+"</h1></strong></center><hr>");
  ...
  st30.close();
    ...
    for (int i=0;i<Integer.parseInt(NBU);i++) {
      ...
      String q40 = "SELECT * FROM CMDB_SERVER WHERE RACKID='"+ID+"' AND U='"+i+"'";
      ...
      if(!isfull) {
        ...
        String q41 = "SELECT * FROM CMDB_SWITCH WHERE RACKID='"+ID+"' AND U='"+i+"'";
      ...
      if(!isfull) {
        Statement st41 = Conn.createStatement();
        String q41 = "SELECT * FROM CMDB_BACKUP WHERE RACKID='"+ID+"' AND U='"+i+"'";
        ResultSet r41 = st41.executeQuery(q41);
        if (r41.next()) {
          String SERVERID=r41.getString("ID");
          String USIZE=r41.getString("USIZE");
      ...
      if(!isfull) {
        Statement st41 = Conn.createStatement();
        String q41 = "SELECT * FROM CMDB_OTHER WHERE RACKID='"+ID+"' AND U='"+i+"'";
        ResultSet r41 = st41.executeQuery(q41);
        if (r41.next()) {
          String SERVERID=r41.getString("ID");
          String USIZE=r41.getString("USIZE");
      ...
      if(!isfull) {
        Statement st41 = Conn.createStatement();
        String q41 = "SELECT * FROM CMDB_SAN WHERE RACKID='"+ID+"' AND U='"+i+"'";
        ResultSet r41 = st41.executeQuery(q41);
        if (r41.next()) {
          String SERVERID=r41.getString("ID");
          String USIZE=r41.getString("USIZE");
