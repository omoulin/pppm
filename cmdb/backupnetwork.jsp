...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEWNETWORK")) {
    ...
    String q3 = "SELECT * FROM CMDB_BACKUP_NETWORK WHERE BACKUPID='"+ID+"' ORDER BY NETWORKID DESC";
    ...
    String i2 = "INSERT INTO CMDB_BACKUP_NETWORK VALUES('"+ID+"','"+NETWORKTYPE+"','"+NETWORKSPEED+"','"+NETWORKADDRESS+"','"+NETWORKMASK+"','"+NETWORKGATEWAY+"','"+idfill+"')";
    ...
    if (!SWITCHID.equals("NONE")) {
      ...
      String i3 = "INSERT INTO CMDB_NETCABLE VALUES('"+ID+" | "+idfill+"','BACKUP','"+SWITCHID+"','"+PLUG+"')";
  ...
  if (act.equals("MODNETWORK")) {
    ...
    String NETWORKGATEWAY = pt.checkStr(request.getParameter("NETWORKGATEWAY"));
    Statement sti2 = Conn.createStatement();
    String i2 = "UPDATE CMDB_BACKUP_NETWORK SET NETWORKTYPE='"+NETWORKTYPE+"',NETWORKSPEED='"+NETWORKSPEED+"',NETWORKGATEWAY='"+NETWORKGATEWAY+"',NETWORKADDRESS='"+NETWORKADDRESS+"',NETWORKMASK='"+NETWORKMASK+"' WHERE BACKUPID='"+ID+"' AND NETWORKID='"+NETWORKID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
    String SWITCHIDtmp=request.getParameter("SWITCHID");
    String SWITCHID="NONE";
    ...
    if (!SWITCHID.equals("NONE")) {
      ...
      String q50 = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" | "+NETWORKID+"' AND ELEMENTTYPE='BACKUP'";
      ResultSet r50 = st50.executeQuery(q50);
      if (r50.next()) {
        Statement sti3 = Conn.createStatement();
        String i3 = "UPDATE CMDB_NETCABLE SET SWITCHID='"+SWITCHID+"',PLUG='"+PLUG+"' WHERE ELEMENTID='"+ID+" | "+NETWORKID+"' AND ELEMENTTYPE='BACKUP'";
        sti3.executeUpdate(i3);
        sti3.close();
      } else {
        Statement sti3 = Conn.createStatement();
        String i3 = "INSERT INTO CMDB_NETCABLE VALUES('"+ID+" | "+NETWORKID+"','BACKUP','"+SWITCHID+"','"+PLUG+"')";
        sti3.executeUpdate(i3);
        sti3.close();
      }
    }
    ...
    String q35 = "SELECT * FROM CMDB_BACKUP_NETWORK WHERE BACKUPID='"+ID+"' ORDER BY NETWORKID";
    ResultSet r35 = st35.executeQuery(q35);
    while(r35.next()) {
      out.print("<tr>");
      out.print("<td bgcolor=\"#FFFFFF\" width=\"10%\"><center>&nbsp<A HREF=\"backupnetworkit.jsp?TODO=MOD&ID="+r35.getString("BACKUPID")+"&NETWORKID="+r35.getString("NETWORKID")+"\">"+r35.getString("NETWORKID")+"</center></A></td>");
      ...
      String q35b = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" | "+r35.getString("NETWORKID")+"' AND ELEMENTTYPE='BACKUP'";
    ...
    out.print("</table>");
    out.print("</form>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"backupnetworkit.jsp?TODO=NEW&ID="+ID+"\" target=\"appliFrame\">");
