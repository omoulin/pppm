...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEWPOWER")) {
    ...
    String q3 = "SELECT * FROM CMDB_OTHER_POWER WHERE OTHERID='"+ID+"' ORDER BY POWERID DESC";
    ...
    String i2 = "INSERT INTO CMDB_OTHER_POWER VALUES('"+ID+"','"+POWERTYPE+"','"+POWERCAPACITY+"','"+idfill+"')";
    ...
    if (!PDUID.equals("NONE")) {
      ...
      String i3 = "INSERT INTO CMDB_POWERCABLE VALUES('"+ID+" | "+idfill+"','OTHER','"+PDUID+"','"+PLUG+"')";
  ...
  if (act.equals("MODPOWER")) {
    ...
    String POWERCAPACITY = pt.checkStr(request.getParameter("POWERCAPACITY"));
    Statement sti2 = Conn.createStatement();
    String i2 = "UPDATE CMDB_OTHER_POWER SET POWERTYPE='"+POWERTYPE+"',POWERCAPACITY='"+POWERCAPACITY+"' WHERE OTHERID='"+ID+"' AND POWERID='"+POWERID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
    String PDUIDtmp=request.getParameter("PDUID");
    String PDUID="NONE";
    ...
    if (!PDUID.equals("NONE")) {
      ...
      String q50 = "SELECT * FROM CMDB_POWERCABLE WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='OTHER'";
      ResultSet r50 = st50.executeQuery(q50);
      if (r50.next()) {
        Statement sti3 = Conn.createStatement();
        String i3 = "UPDATE CMDB_POWERCABLE SET PDUID='"+PDUID+"',PLUG='"+PLUG+"' WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='OTHER'";
        sti3.executeUpdate(i3);
        sti3.close();
      } else {
        Statement sti3 = Conn.createStatement();
        String i3 = "INSERT INTO CMDB_POWERCABLE VALUES('"+ID+" | "+POWERID+"','OTHER','"+PDUID+"','"+PLUG+"')";
        sti3.executeUpdate(i3);
        sti3.close();
      }
    }
    ...
    String q35 = "SELECT * FROM CMDB_OTHER_POWER WHERE OTHERID='"+ID+"' ORDER BY POWERID";
    ResultSet r35 = st35.executeQuery(q35);
    while(r35.next()) {
      out.print("<tr>");
      out.print("<td bgcolor=\"#FFFFFF\" width=\"10%\"><center>&nbsp<A HREF=\"otherpowerit.jsp?TODO=MOD&ID="+r35.getString("OTHERID")+"&POWERID="+r35.getString("POWERID")+"\">"+r35.getString("POWERID")+"</center></A></td>");
    ...
    out.print("</table>");
    out.print("</form>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"otherpowerit.jsp?TODO=NEW&ID="+ID+"\" target=\"appliFrame\">");
