...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEW")) {
    ...
    String i2 = "INSERT INTO CMDB_BACKUP VALUES('"+ID+"','"+DESCRIPTION+"','"+RACKID+"','"+U+"','"+USIZE+"','"+idfil+"','"+SITEID+"','"+VENDORID+"')";
  ...
  if (act.equals("MOD")) {
    ...
    Statement sti2 = Conn.createStatement();
    String i2 = "UPDATE CMDB_BACKUP SET DESCRIPTION='"+DESCRIPTION+"',RACKID='"+RACKID+"',U='"+U+"',USIZE='"+USIZE+"',CONTRACTID='"+idfil+"',SITEID='"+SITEID+"',VENDORID='"+VENDORID+"' WHERE ID='"+ID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
  }

   out.print("<center><strong><h1>Backup System list</h1></strong></center><hr>");
   


    out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
    out.print("<tr BGCOLOR=\"#9A9A9A\">");
    out.print("<td background=\"images/fond_titre.jpg\"><center>BACKUP ID</center></td>");
    ...
    String q30 = "SELECT * FROM CMDB_BACKUP ORDER BY ID";
    ResultSet r30 = st30.executeQuery(q30);
    while(r30.next()) {
      out.print("<tr>");
      out.print("<td bgcolor=\"#FFFFFF\"><center>&nbsp<A HREF=\"backupit.jsp?TODO=MOD&ID="+r30.getString("ID")+"\">"+r30.getString("ID")+"</center></A></td>");
      ...
      String q131 = "SELECT * FROM CMDB_BACKUP_POWER WHERE BACKUPID='"+r30.getString("ID")+"'";
      ResultSet r131 = st131.executeQuery(q131);
      while(r131.next()) {
        nbpower++;
      }
      st131.close();
      out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"backuppower.jsp?TODO=NONE&ID="+r30.getString("ID")+"\">"+nbpower+"</center></A></td>");    
      int nbnet=0;
      Statement st133 = Conn.createStatement();
      String q133 = "SELECT * FROM CMDB_BACKUP_NETWORK WHERE BACKUPID='"+r30.getString("ID")+"'";
      ResultSet r133 = st133.executeQuery(q133);
      while(r133.next()) {
        nbnet++;
      }
      st133.close();
      out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"backupnetwork.jsp?TODO=NONE&ID="+r30.getString("ID")+"\">"+nbnet+"</center></A></td>");    
    ...
    out.print("</table>");
    out.print("</form>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"backupit.jsp?TODO=NEW\" target=\"appliFrame\">");
