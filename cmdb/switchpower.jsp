...
if (Userlogin==null) {
  ...
  if (act.equals("NEWPOWER")) {
    ...
    String q3 = "SELECT * FROM CMDB_SWITCH_POWER WHERE SWITCHID='"+ID+"' ORDER BY POWERID DESC";
    ...
    String i2 = "INSERT INTO CMDB_SWITCH_POWER VALUES('"+ID+"','"+POWERTYPE+"','"+POWERCAPACITY+"','"+idfill+"')";
    ...
    if (!PDUID.equals("NONE")) {
      ...
      String i3 = "INSERT INTO CMDB_POWERCABLE VALUES('"+ID+" | "+idfill+"','SWITCH','"+PDUID+"','"+PLUG+"')";
  ...
  if (act.equals("MODPOWER")) {
    ...
    String POWERCAPACITY = pt.checkStr(request.getParameter("POWERCAPACITY"));
    Statement sti2 = Conn.createStatement();
    String i2 = "UPDATE CMDB_SWITCH_POWER SET POWERTYPE='"+POWERTYPE+"',POWERCAPACITY='"+POWERCAPACITY+"' WHERE SWITCHID='"+ID+"' AND POWERID='"+POWERID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
    String PDUIDtmp=request.getParameter("PDUID");
    String PDUID="NONE";
    ...
    if (!PDUID.equals("NONE")) {
      ...
      String q50 = "SELECT * FROM CMDB_POWERCABLE WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='SWITCH'";
      ResultSet r50 = st50.executeQuery(q50);
      if (r50.next()) {
        Statement sti3 = Conn.createStatement();
        String i3 = "UPDATE CMDB_POWERCABLE SET PDUID='"+PDUID+"',PLUG='"+PLUG+"' WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='SWITCH'";
        sti3.executeUpdate(i3);
        sti3.close();
      } else {
        Statement sti3 = Conn.createStatement();
        String i3 = "INSERT INTO CMDB_POWERCABLE VALUES('"+ID+" | "+POWERID+"','SWITCH','"+PDUID+"','"+PLUG+"')";
        sti3.executeUpdate(i3);
        sti3.close();
      }
    }
  ...
  if (act.equals("DELETE")) {
    Statement sti2 = Conn.createStatement();
    String i2 = "DELETE FROM CMDB_SWITCH_POWER WHERE POWERID='"+POWERID+"' AND SWITCHID='"+ID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
  }
  out.print("<center><strong><h1>Power adapter(s)</h1></strong></center><hr>");
  out.print("<table><tr><td><h2><strong>Power adapter(s)</strong></h2></center></td><td><center><A HREF=\"switchpowerit.jsp?TODO=NEW&ID="+ID+"\"><img border=0 src=\"icons/addsmall.png\"></center></A></td></tr></table></td>");
  ...
  String q35 = "SELECT * FROM CMDB_SWITCH_POWER WHERE SWITCHID='"+ID+"' ORDER BY POWERID";
  ResultSet r35 = st35.executeQuery(q35);
  while(r35.next()) {
    out.print("<tr>");
    out.print("<td bgcolor=\"#FFFFFF\" width=\"10%\"><center>&nbsp<A HREF=\"switchpowerit.jsp?TODO=MOD&ID="+r35.getString("SWITCHID")+"&POWERID="+r35.getString("POWERID")+"\">"+r35.getString("POWERID")+"</center></A></td>");
    ...
    String q35b = "SELECT * FROM CMDB_POWERCABLE WHERE ELEMENTID='"+ID+" | "+r35.getString("POWERID")+"' AND ELEMENTTYPE='SWITCH'";
    ...
    st35b.close();
    out.print("<td><center><A HREF=\"deleteswitchpower.jsp?TODO=MOD&ID="+ID+"&POWERID="+r35.getString("POWERID")+"\"><img border=0 src=\"icons/deletesmall.png\" height=15></center></A></td>");
    out.print("</tr>");
  }
  st35.close();
  out.print("</table>");
