...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEW")) {
    ...
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"switchpower.jsp?TODO=NEWPOWER&ID="+ID+"\" target=\"_top\">");
  } else {
    out.print("<center><strong><h1>Modify Power Adapter</h1></strong></center><hr>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"switchpower.jsp?TODO=MODPOWER&ID="+ID+"&POWERID="+POWERID+"\" target=\"_top\">");
    Statement st30 = Conn.createStatement();
    String q30 = "SELECT * FROM CMDB_SWITCH_POWER WHERE SWITCHID='"+ID+"' AND POWERID='"+POWERID+"'";
    ...
    String q31 = "SELECT * FROM CMDB_POWERCABLE WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='SWITCH'";
  ...
  Statement st31 = Conn.createStatement();
  String q31 = "SELECT * FROM CMDB_SWITCH WHERE ID='"+ID+"'";
  ResultSet r31 = st31.executeQuery(q31);
  String RACKID="NONE";
  if (r31.next()) {
