...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEW")) {
    ...
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"otherpower.jsp?TODO=NEWPOWER&ID="+ID+"\" target=\"appliFrame\">");
  } else {
    out.print("<center><strong><h1>Modify Power Adapter</h1></strong></center><hr>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"otherpower.jsp?TODO=MODPOWER&ID="+ID+"&POWERID="+POWERID+"\" target=\"appliFrame\">");
    Statement st30 = Conn.createStatement();
    String q30 = "SELECT * FROM CMDB_OTHER_POWER WHERE OTHERID='"+ID+"' AND POWERID='"+POWERID+"'";
    ...
    String q31 = "SELECT * FROM CMDB_POWERCABLE WHERE ELEMENTID='"+ID+" | "+POWERID+"' AND ELEMENTTYPE='OTHER'";
  ...
  Statement st31 = Conn.createStatement();
  String q31 = "SELECT * FROM CMDB_OTHER WHERE ID='"+ID+"'";
  ResultSet r31 = st31.executeQuery(q31);
  String RACKID="NONE";
  if (r31.next()) {
