...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  String SPID="";
    ...
    String q3 = "SELECT * FROM CMDB_BACKUP WHERE ID='"+ID+"'";
    ...
    out.print("<center><strong><h1>Backup Configuration : "+ID+"</h1></strong></center><hr>");
 
    out.print("<br><center><img src=\"images/backup/"+Integer.parseInt(USIZE)+"U.jpg\"></center><br>");
    ...
    String q33 = "SELECT * FROM CMDB_BACKUP_NETWORK WHERE BACKUPID='"+ID+"' ORDER BY NETWORKID";
    ...
    while(r33.next()) {
      ...
      String q33b = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" - "+r33.getString("NETWORKID")+"' AND ELEMENTTYPE='BACKUP'";
