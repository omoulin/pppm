...
if (Userlogin==null) {
  ...
  if (act.equals("NEWNETWORK")) {
    ...
    String q3 = "SELECT * FROM CMDB_SAN_NETWORK WHERE SANID='"+ID+"' ORDER BY NETWORKID DESC";
    ...
    String i2 = "INSERT INTO CMDB_SAN_NETWORK VALUES('"+ID+"','"+NETWORKTYPE+"','"+NETWORKSPEED+"','"+NETWORKADDRESS+"','"+NETWORKMASK+"','"+NETWORKGATEWAY+"','"+idfill+"')";
    ...
    if (!SWITCHID.equals("NONE")) {
      ...
      String i3 = "INSERT INTO CMDB_NETCABLE VALUES('"+ID+" | "+idfill+"','SAN','"+SWITCHID+"','"+PLUG+"')";
  ...
  if (act.equals("MODNETWORK")) {
    ...
    String NETWORKGATEWAY = pt.checkStr(request.getParameter("NETWORKGATEWAY"));
    Statement sti2 = Conn.createStatement();
    String i2 = "UPDATE CMDB_SAN_NETWORK SET NETWORKTYPE='"+NETWORKTYPE+"',NETWORKSPEED='"+NETWORKSPEED+"',NETWORKGATEWAY='"+NETWORKGATEWAY+"',NETWORKADDRESS='"+NETWORKADDRESS+"',NETWORKMASK='"+NETWORKMASK+"' WHERE SANID='"+ID+"' AND NETWORKID='"+NETWORKID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
    String SWITCHIDtmp=request.getParameter("SWITCHID");
    String SWITCHID="NONE";
    ...
    if (!SWITCHID.equals("NONE")) {
      ...
      String q50 = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" | "+NETWORKID+"' AND ELEMENTTYPE='SAN'";
      ResultSet r50 = st50.executeQuery(q50);
      if (r50.next()) {
        Statement sti3 = Conn.createStatement();
        String i3 = "UPDATE CMDB_NETCABLE SET SWITCHID='"+SWITCHID+"',PLUG='"+PLUG+"' WHERE ELEMENTID='"+ID+" | "+NETWORKID+"' AND ELEMENTTYPE='SAN'";
        sti3.executeUpdate(i3);
        sti3.close();
      } else {
        Statement sti3 = Conn.createStatement();
        String i3 = "INSERT INTO CMDB_NETCABLE VALUES('"+ID+" | "+NETWORKID+"','SAN','"+SWITCHID+"','"+PLUG+"')";
        sti3.executeUpdate(i3);
        sti3.close();
      }
    }
  ...
  if (act.equals("DELETE")) {
    Statement sti2 = Conn.createStatement();
    String i2 = "DELETE FROM CMDB_SAN_NETWORK WHERE NETWORKID='"+NETWORKID+"' AND SANID='"+ID+"'";
    sti2.executeUpdate(i2);
    sti2.close();
  }
  out.print("<center><strong><h1>Network adapter(s)</h1></strong></center><hr>");
  out.print("<table><tr><td><h2><strong>Network adapter(s)</strong></h2></center></td><td><center><A HREF=\"sannetworkit.jsp?TODO=NEW&ID="+ID+"\"><img border=0 src=\"icons/addsmall.png\"></center></A></td></tr></table></td>");
  out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
  out.print("<tr>");
  out.print("<td background=\"images/fond_titre.jpg\" width=\"10%\"><center>NETWORK #</center></td>");
  ...
  String q35 = "SELECT * FROM CMDB_SAN_NETWORK WHERE SANID='"+ID+"' ORDER BY NETWORKID";
  ResultSet r35 = st35.executeQuery(q35);
  while(r35.next()) {
    out.print("<tr>");
    out.print("<td bgcolor=\"#FFFFFF\" width=\"10%\"><center>&nbsp<A HREF=\"sannetworkit.jsp?TODO=MOD&ID="+r35.getString("SANID")+"&NETWORKID="+r35.getString("NETWORKID")+"\">"+r35.getString("NETWORKID")+"</center></A></td>");
    ...
    String q35b = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" | "+r35.getString("NETWORKID")+"' AND ELEMENTTYPE='SAN'";
    ...
    st35b.close();
    out.print("<td><center><A HREF=\"deletesannetwork.jsp?TODO=MOD&ID="+r35.getString("SANID")+"&NETWORKID="+r35.getString("NETWORKID")+"\"><img border=0 src=\"icons/deletesmall.png\" height=15></center></A></td>");
    out.print("</tr>");
  }
  st35.close();
  out.print("</table>");
