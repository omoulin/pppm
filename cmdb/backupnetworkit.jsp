...
<%String Userlogin = (String)session.getAttribute("LOGIN");
  ...
  if (act.equals("NEW")) {
    ...
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"backupnetwork.jsp?TODO=NEWNETWORK&ID="+ID+"\" target=\"appliFrame\">");
  } else {
    out.print("<center><strong><h1>Modify Network Adapter</h1></strong></center><hr>");
    out.print("<form name=\"formFILTER\" method=\"post\" action=\"backupnetwork.jsp?TODO=MODNETWORK&ID="+ID+"&NETWORKID="+NETWORKID+"\" target=\"appliFrame\">");
    Statement st30 = Conn.createStatement();
    String q30 = "SELECT * FROM CMDB_BACKUP_NETWORK WHERE BACKUPID='"+ID+"' AND NETWORKID='"+NETWORKID+"'";
    ...
    String q31 = "SELECT * FROM CMDB_NETCABLE WHERE ELEMENTID='"+ID+" | "+NETWORKID+"' AND ELEMENTTYPE='BACKUP'";
  ...
  out.print("<tr><td>Name of the backup : </td><td>"+ID+"</td></tr>");
