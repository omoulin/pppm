...
<body>
    ...
    {
    	window.showModalDialog('sanit.jsp?TODO=NEW&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalMOD(reqstr)
    {
    	window.showModalDialog('sanit.jsp?TODO=MOD&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    ...
    {
    	window.showModalDialog('deletesan.jsp?TODO=DELETE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    ...
    {
    	window.showModalDialog('sandisp.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalCONF(reqstr)
    {
    	window.showModalDialog('sanconf.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    function showModalNET(reqstr)
    {
    	window.showModalDialog('sannetwork.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
    <script>
    ...
    {
    	window.showModalDialog('sanpower.jsp?TODO=NONE&'+reqstr,'','dialogHeight:400px;dialogWidth:800px;');
        top.appliFrame.location='san.jsp?TODO=NONE';
    }
    </script>
...
if (Userlogin==null) {
  ...
  out.print("<center><strong><h1>SAN list</h1></strong></center><hr>");
  out.print("<table><tr><td><h2><strong>SAN(s)</strong></h2></center></td><td><center><A HREF=\"#\" onclick=\"showModalADD('');\"><img border=0 src=\"icons/addsmall.png\"></center></A></td></tr></table></td>");
  out.print("<table border=\"0\" CELLSPACING=\"2\" BORDERCOLOR=\"#000000\" width=\"100%\">");
  out.print("<tr>");
  out.print("<td background=\"images/fond_titre.jpg\"><center>SAN ID</center></td>");
  ...
  out.print("<td background=\"images/fond_titre.jpg\"><center>FIBER PORT</center></td>"); 
  out.print("<td background=\"images/fond_titre.jpg\"><center>POWER ADAPTER</center></td>"); 
  out.print("<td background=\"images/fond_titre.jpg\"><center>NETWORK ADAPTER</center></td>");
  ...
  String q30 = "SELECT * FROM CMDB_SAN ORDER BY ID";
  ...
  while(r30.next()) {
    ...
    out.print("<td bgcolor=\"#FFFFFF\"><center>&nbsp<A HREF=\"#\" onclick=\"showModalCONF('ID="+r30.getString("ID")+"');\">Config</center></A></td>");
    ...
    String q131 = "SELECT * FROM CMDB_SAN_POWER WHERE SANID='"+r30.getString("ID")+"'";
    ...
    int nbnet=0;
    Statement st133 = Conn.createStatement();
    String q133 = "SELECT * FROM CMDB_SAN_NETWORK WHERE SANID='"+r30.getString("ID")+"'";
    ResultSet r133 = st133.executeQuery(q133);
    while(r133.next()) {
      nbnet++;
    }
    st133.close();
    out.print("<td bgcolor=\"#FFFFFF\"><center><A HREF=\"#\" onclick=\"showModalNET('ID="+r30.getString("ID")+"');\">"+nbnet+"</center></A></td>"); 
