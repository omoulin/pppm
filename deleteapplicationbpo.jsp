  ...
  <body>
    <%
      ...
      if (Userlogin==null) {
        ...
        out.print("<form name=\"formFILTER\" method=\"post\" action=\"applicationdetails.jsp?TODO=BPODELETE&EMPLOYEEID="+EMPLOYEEID+"&APPLICATIONID="+APPLICATIONID+"\" target=\"_top\">");
        out.print("<table>");
        ...
        STR02.close();
        out.print("<tr><td><H1>Are you sure that you want to delete this BPO from this application ??</H1></td><td>&nbsp;</td></tr>");
