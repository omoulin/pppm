  ...
  <body>
    ...
    <%
      ...
      if (Userlogin==null) {
        ...
        if (act.equals("ADD")) {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productbudget.jsp?TODO=BUDADD&PRODUCTID="+PRODUCTID+"\" target=\"_top\">");
        } else {
          out.print("<form name=\"formFILTER\" method=\"post\" action=\"productbudget.jsp?TODO=BUDMOD&PRODUCTID="+PRODUCTID+"&BUDGETID="+BUDGETID+"\" target=\"_top\">");
        }
        if (act.equals("MOD")) {
          Statement STR01 = Conn.createStatement();
          String QR01 = "SELECT ID,DESCRIPTION,TYPE,AMOUNT,DATEBUD,CER FROM PRODUCT_BUDGET WHERE PRODUCTID='"+PRODUCTID+"' AND ID="+BUDGETID;
